...
function App() {
  ...
  const allHistory: Array<{
    ...
    room.history.map((entry) => ({ roomId: room.id, entry }))
  );
        ...
        >
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                setOccupantForm((f) => f && { ...f, name: e.target.value })
              }
            />
            <input
              required
              ...
              onChange={(e) =>
                setOccupantForm((f) => f && { ...f, aadhar: e.target.value })
              }
            />
            <input
              required
              ...
              onChange={(e) =>
                setOccupantForm((f) => f && { ...f, occupants: e.target.value })
              }
            />
            <input
              required
              ...
              onChange={(e) =>
                setOccupantForm((f) => f && { ...f, address: e.target.value })
              }
            />
              ...
              <tbody>
                {allHistory.map(({ roomId, entry }, idx) => (
                  <tr key={idx}>
                    ...
                    <td style={{ border: "1px solid #ccc", padding: 4 }}>
                      {entry.occupantData?.name || ""}
                    </td>
                    <td style={{ border: "1px solid #ccc", padding: 4 }}>
                      {entry.occupantData?.aadhar || ""}
                    </td>
                    <td style={{ border: "1px solid #ccc", padding: 4 }}>
                      {entry.occupantData?.occupants || ""}
                    </td>
                    <td style={{ border: "1px solid #ccc", padding: 4 }}>
                      {entry.occupantData?.address || ""}
                    </td>
                  </tr>
                ))}
              </tbody>
      ...
      >
        <button
          ...
          onClick={() => {
            if (
              window.confirm(
                "Are you sure you want to delete ALL room data? This cannot be undone."
              )
            ) {
              setRooms(
                Array.from({ length: MAX_ROOMS }, (_, i) => ({
                  id: i,
                  status: "available" as RoomStatus,
                  history: [],
                }))
